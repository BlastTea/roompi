...
class ExerciseHeader extends SliverPersistentHeaderDelegate {
  ...
  @override
  bool shouldRebuild(covariant ExerciseHeader oldDelegate) => oldDelegate.title != title || oldDelegate.mention != mention || oldDelegate.totalExp != totalExp || oldDelegate.description != description;
}
