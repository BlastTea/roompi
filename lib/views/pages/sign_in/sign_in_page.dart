      ...
      BlocBuilder<AuthenticationBloc, AuthenticationState>(
        builder: (context, stateAuthentication) {
          ...
          if (kDebugMode) {
            ...
            stateAuthentication.textControllerEmailSignIn.text =
                dotenv.env['USERNAME_DUMMY_REMAJA']!;
            stateAuthentication.textControllerPasswordSignIn.text =
                dotenv.env['PASSWORD_DUMMY_REMAJA']!;
          }
          return Scaffold(
            appBar: AppBar(
              titleSpacing: 0,
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('Mulai jelajahi Roompi',
                      ...
                      Padding(
                        ...
                        child: TextField(
                          controller:
                              stateAuthentication.textControllerEmailSignIn,
                      ...
                      Padding(
                        ...
                        child: TextField(
                          controller:
                              stateAuthentication.textControllerPasswordSignIn,
                          decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              icon: Icon(
                                  !stateAuthentication.isSignInPasswordVisible
                                      ? Icons.visibility
