...
_$ExerciseImpl _$$ExerciseImplFromJson(Map<String, dynamic> json) =>
    _$ExerciseImpl(
      ...
      dataBagian: (json['data_bagian'] as List<dynamic>?)
...
Map<String, dynamic> _$$ExerciseImplToJson(_$ExerciseImpl instance) =>
    <String, dynamic>{
      ...
      'data_bagian': instance.dataBagian,
    };

_$ExercisePartImpl _$$ExercisePartImplFromJson(Map<String, dynamic> json) =>
    _$ExercisePartImpl(
      bagianId: _parseInt(json['bagian_id']),
      namaBagian: json['nama_bagian'] as String?,
      dataSubBagian: (json['data_sub_bagian'] as List<dynamic>?)
          ?.map((e) => ExerciseSubsection.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$ExercisePartImplToJson(_$ExercisePartImpl instance) =>
    <String, dynamic>{
      'bagian_id': instance.bagianId,
      'nama_bagian': instance.namaBagian,
      'data_sub_bagian': instance.dataSubBagian,
    };

_$ExerciseSubsectionImpl _$$ExerciseSubsectionImplFromJson(
...
Map<String, dynamic> _$$ExerciseSubsectionImplToJson(
        _$ExerciseSubsectionImpl instance) =>
    <String, dynamic>{
